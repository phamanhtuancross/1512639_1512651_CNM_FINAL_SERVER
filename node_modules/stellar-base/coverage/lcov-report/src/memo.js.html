...
<html lang="en">
<head>
    <title>Code coverage report for src/memo.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> memo.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">91.78% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>67/73</span>
      </div>
      <div class='fl pad1y'>
...
&nbsp;
  set type<span class="fstat-no" title="function not covered" >(type) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error("Memo is immutable");</span>
  }
&nbsp;
  /**
   * Contains memo value:
  ...
  get value() {
    switch (this._type) {
      ...
      case MemoHash:
      case MemoReturn:
        return Buffer.from(this._value);<span class="branch-5 cbranch-no" title="branch not covered" ></span>
      default:
<span class="cstat-no" title="statement not covered" >        throw new Error("Invalid memo type");</span>
    }
  }
&nbsp;
  set value<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error("Memo is immutable");</span>
  }
&nbsp;
...
&nbsp;
    // Infinity
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!number.isFinite()) {
<span class="cstat-no" title="statement not covered" >      throw error;</span>
    }
&nbsp;
    // NaN
    <span class="missing-if-branch" title="if path not taken" >I</span>if (number.isNaN()) {
<span class="cstat-no" title="statement not covered" >      throw error;</span>
    }
  }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof object.value() === "undefined") {
      return Memo.none();
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error("Unknown type");</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
