...
<html lang="en">
<head>
    <title>Code coverage report for src/keypair.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> keypair.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">8 statements, 10 branches</span>
...
export class Keypair {
  constructor(keys) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (keys.type != "ed25519") {
<span class="cstat-no" title="statement not covered" >      throw new Error("Invalid keys type");</span>
    }
&nbsp;
    this.type = keys.type;
&nbsp;
...
&nbsp;
   ...
   */
  static master() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Network.current() === null) {
<span class="cstat-no" title="statement not covered" >      throw new Error("No network selected. Use `Network.use`, `Network.usePublicNetwork` or `Network.useTestNetwork` helper methods to select network.");</span>
    }
...
&nbsp;
  ...
  static fromPublicKey(publicKey) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (publicKey.length !== 32) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid Stellar public key');</span>
    }
...
&nbsp;
  xdrPublicKey<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new xdr.PublicKey.publicKeyTypeEd25519(this._publicKey);</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
  secret() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._secretSeed) {
<span class="cstat-no" title="statement not covered" >      throw new Error("no secret key available");</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.type == 'ed25519') {
      return StrKey.encodeEd25519SecretSeed(this._secretSeed);
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error("Invalid Keypair type");</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
  sign(data) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.canSign()) {
<span class="cstat-no" title="statement not covered" >      throw new Error("cannot sign: no secret key available");</span>
    }
&nbsp;
