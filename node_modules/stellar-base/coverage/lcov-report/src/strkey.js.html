...
<html lang="en">
<head>
    <title>Code coverage report for src/strkey.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> strkey.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.84% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>92/95</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import base32 from "base32.js";
import crc from "crc";
...
&nbsp;
  try {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (decoded.length !== 32) {
...
<span class="cstat-no" title="statement not covered" >    throw new Error(`${versionByteName} is not a valid version byte name.  expected one of "accountId" or "seed"`);</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isUndefined(versionByte)) {
<span class="cstat-no" title="statement not covered" >    throw new Error(`${versionByteName} is not a valid version byte name.  expected one of "ed25519PublicKey", "ed25519SecretSeed", "preAuthTx", "sha256Hash"`);</span>
  }
&nbsp;
