  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>201/204</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>138/141</span>
      </div>
      <div class='fl pad1y'>
        <span class="strong">11 statements, 2 functions, 11 branches</span>
...
&nbsp;
  static setSourceAccount(opAttributes, opts) {
    if (opts.source) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!StrKey.isValidEd25519PublicKey(opts.source)) {
        throw new Error("Source address is invalid");
      }
<span class="cstat-no" title="statement not covered" >      opAttributes.sourceAccount = Keypair.fromPublicKey(opts.source).xdrAccountId();</span>
    }
  }
&nbsp;
  /**
...
&nbsp;
      if (attrs.signer()) {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (arm == "hashX") {
...
&nbsp;
      ...
      break;<span class="branch-12 cbranch-no" title="branch not covered" ></span>
      default:
