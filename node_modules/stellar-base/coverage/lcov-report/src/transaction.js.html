...
<html lang="en">
<head>
    <title>Code coverage report for src/transaction.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> transaction.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {xdr, hash} from "./index";
&nbsp;
...
&nbsp;
    let operations  = this.tx.operations() || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
&nbsp;
  set memo<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error("Transaction is immutable");</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
  signHashX(preimage) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isString(preimage)) {
<span class="cstat-no" title="statement not covered" >      preimage = Buffer.from(preimage, "hex");</span>
    }
&nbsp;
