...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/inflation.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/operations/</a> inflation.js
    </h1>
    <div class='clearfix'>
...
/**
  ...
  */
export const inflation = function(opts<span class="branch-1 cbranch-no" title="branch not covered" >=</span>{}<span class="branch-1 cbranch-no" title="branch not covered" >)</span> {
    let opAttributes = {};
