...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/set_options.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/operations/</a> set_options.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!(Buffer.isBuffer(opts.signer.preAuthTx) &amp;&amp; opts.signer.preAuthTx.length == 32)) {
<span class="cstat-no" title="statement not covered" >        throw new Error("signer.preAuthTx must be 32 bytes Buffer.");</span>
      }
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!(Buffer.isBuffer(opts.signer.sha256Hash) &amp;&amp; opts.signer.sha256Hash.length == 32)) {
<span class="cstat-no" title="statement not covered" >        throw new Error("signer.sha256Hash must be 32 bytes Buffer.");</span>
      }
