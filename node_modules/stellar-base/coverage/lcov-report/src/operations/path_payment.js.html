...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/path_payment.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/operations/</a> path_payment.js
    </h1>
    <div class='clearfix'>
...
export const pathPayment = function(opts) {
  switch (true) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case !opts.sendAsset:</span>
<span class="cstat-no" title="statement not covered" >      throw new Error("Must specify a send asset");</span>
    ...
    case !StrKey.isValidEd25519PublicKey(opts.destination):
      throw new Error("destination is invalid");<span class="branch-3 cbranch-no" title="branch not covered" ></span>
    case !opts.destAsset:
